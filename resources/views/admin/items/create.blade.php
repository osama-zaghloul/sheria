...
@section('title') لوحة التحكم | إضافة عنصر جديد @endsection
@section('content')
...
<section class="content">
        <div class="row">
              ...
              <div class="box-header with-border">
                <h3 class="box-title">إضافة عنصر جديد</h3>
              </div>
              ...
              {!! Form::open(array('method' => 'POST','files' => true,'url' =>'adminpanel/items')) !!}
                <div class="box-body">  
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="artitle" placeholder="ادخل اسم العنصر " value="{{ old('artitle') }}" required>
                   ...
                   <div class="col-md-12">
                      <div class="box box-info">
                          ...
                          <div class="box-body pad">
                              <textarea id="editor1" name="discount_text" rows="10" cols="167" required>{!! old('discount_text') !!}</textarea>
                  ...
                  <div class="col-md-12">
                      <div class="box box-info">
                          ...
                          <div class="box-body pad">
                              <textarea id="editor2" name="ardesc" rows="10" cols="167" required>{!! old('ardesc') !!}</textarea>
                  ...
                  {{-- <div class="row">
                       <div class="form-group col-md-6">
                      <label> العنوان</label>
                      <input type="text" id="pac-input" name="address" class="form-control" placeholder = 'العنوان '>
                      @if ($errors->has('address'))
                          <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('address') }}</div>
                      @endif  
                  </div>
                  ...
                  <div id="map" class="form-body col-md-12" style="height:500px;width:1000px;">
...
{{-- <script> --}}
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCrsTVja4leOLfOxV6EfP1oSyQv_bpj7yg&libraries=places&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
