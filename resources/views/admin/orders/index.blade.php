                                    ...
                                    <table id="example3" class="table table-bordered table-striped">
                                        ...
                                        @foreach($itemorders  as $order)
                                            ...
                                            @if($dayorders == $nowday && $weekorders == $nowweek && $monthorders == $nowmonth && $yearorders == $nowyear)
                                                <tr>
                                                    <td style="text-align:center;">#{{$order->invite_code}} </td>
                                                    ...
                                                    <td style="text-align:center;">
                                                        ...
                                                        @elseif($order->status == 2) 
                                                           ...
                                                           @elseif($order->status == 1) 
                                                           <span style="border-radius: 3px;border: 1px solid #236b2c;float:left;color:rgb(53, 99, 39);padding: 3px;font-weight: bold;background: #fff;display: inline-block;margin-top: 4%;" class="ads__item__featured">مقبول</span>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td style="text-align:center;"> 
                                                        @if($order->status == 0)
                                                            <span style="border-radius: 3px;border: 1px solid green;color: orange;float:left;padding: 3px;font-weight: bold;background: #fff;display: inline-block;margin-top: 4%;" class="ads__item__featured">قيد الانتظار</span>
                                                        @elseif($order->status == 1) 
                                                             <span style="border-radius: 3px;border: 1px solid green;color: springgreen;float:left;padding: 3px;font-weight: bold;background: #fff;display: inline-block;margin-top: 4%;" class="ads__item__featured"> تم قبول الطلب</span>
                                                        @elseif($order->status == 2)   
                                                    ...
                                                    <td style="text-align:center;">
                                                        ...
                                                        @elseif($order->status == 2) 
                                                           ...
                                                           @elseif($order->status == 1) 
                                                           <span style="border-radius: 3px;border: 1px solid #c22356;float:left;color:crimson;padding: 3px;font-weight: bold;background: #fff;display: inline-block;margin-top: 4%;" class="ads__item__featured">مقبول</span>
